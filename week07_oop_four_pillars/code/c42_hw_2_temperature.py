...
# pseudocode:
            ...
            # 2.create special method __init__(self,_celsius) then self._celsius = _celsius
            # 3.create another set_celsius(self). if self._celsius<-273 then print invalid, if self._celsius>-273 then 
            #   print (f - 32) * 5 / 9.
...
class Temperature:
    ...
    def set_celsius(self,value):
        ...
        if self._celsius > -273:
            self._celsius=value
            print("Temperature set:", self._celsius)

Temp1 = Temperature(-110)

temp2 = Temperature(-345)

Temp1.set_celsius(192)

temp2.set_celsius(20)
